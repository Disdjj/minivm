...
3. Replace QEMU-backed boot with a custom KVM-backed boot path.
4. Replace QEMU-provided virtio-net with a custom device model.
5. Add stronger isolation and operational features only after the minimal self-hosted VMM exists.
